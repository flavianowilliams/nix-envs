...
#  networking.wireless.networks."IFPR_ADM".pskRaw = "592cc205395822ef8d4f37c589208adff82fc5cac27b3bb6552a22abcf5530ca";
...
#  ];
   ...
   networking.wireless.iwd.settings = {
     ...
     Security = {
       EAP-Method = "PEAP";
       EAP-Identity = "flaviano.fernandes";
...
#  fonts.packages = with pkgs; [ nerdfonts ];
  ...
  environment.systemPackages = with pkgs; [
    ...
    udisks
    dropbox
    gnome-keyring #remover depois!!!
    update-systemd-resolved #remover depois!!!!
  ];
